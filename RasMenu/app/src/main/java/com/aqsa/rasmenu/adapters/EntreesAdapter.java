...
public class EntreesAdapter extends RecyclerView.Adapter<EntreesAdapter.MyViewHolder> {
        private Activity activity;
        private ArrayList<Entree> data;

    public EntreesAdapter(Activity activity, ArrayList<Entree> data) {
        ...
        @NonNull
        @Override
        public EntreesAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View root = LayoutInflater.from(activity).inflate(R.layout.activity_view_items, null, false);
            return new MyViewHolder(root);
        }

        @Override
        public void onBindViewHolder(@NonNull EntreesAdapter.MyViewHolder holder, int position) {
